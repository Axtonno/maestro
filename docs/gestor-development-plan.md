...
| Fase | Titolo | Stato iniziale | Dipende da |
|---|---|---|---|
| 1 | Contratti, modello di dominio e ADR | Pronta | Design iniziale |
| 2 | Snapshot Registry | Pianificata | Fase 1 |
