...
const ERROR_CATALOG = Object.freeze({
  ...
  chat_model_missing: ['Chat model unavailable', 'The configured Direct Chat model or digest is not available from the local provider.', 'Run Doctor'],
  cli_incompatible: ['Maestro CLI upgrade required', 'This extension requires the workspace and profile contract provided by the current Maestro candidate.', 'Open Troubleshooting'],
  ...
  cli_output_limit: ['Maestro output limit reached', 'The CLI response exceeded the extension safety limit.', 'Open Troubleshooting'],
  command_canceled: ['Maestro request canceled', 'The request was canceled before Maestro completed.', 'Retry'],
  command_timeout: ['Maestro request timed out', 'The local CLI did not complete within the bounded request time.', 'Run Doctor'],
  ...
  dev_container_unqualified: ['Dev Container not qualified', 'This candidate does not claim Dev Containers because no clean container gate has been completed.', 'Open Troubleshooting'],
  extension_host_mismatch: ['Remote extension host required', 'Maestro is connected to a supported remote workspace but the extension is running on the local UI host.', 'Open Troubleshooting'],
  ...
  mutation_model_missing: ['Mutation model unavailable', 'The configured Controlled Mutation model or digest is not available from the local provider.', 'Run Doctor'],
  platform_unsupported: ['Extension host not supported', 'This candidate requires a qualified Linux extension host: local Linux or Remote WSL.', 'Open Setup Guide'],
  profile_mismatch: ['Maestro profile mismatch', 'The effective CLI profile does not match the workspace profile selected in Settings.', 'Open Settings'],
  provider_unavailable: ['Ollama is not reachable', 'The configured local provider could not be reached from the extension host.', 'Run Doctor'],
  ...
  remote_unsupported: ['Remote workspace not supported', 'This candidate supports Remote WSL; Remote SSH, Codespaces, tunnels, and unknown remotes are not qualified.', 'Open Troubleshooting'],
